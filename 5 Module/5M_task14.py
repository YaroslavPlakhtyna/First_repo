...
def find_all_phones(text):
    result = re.findall(r'\+380\(\d{2}\)\d{3}-\d-\d{3}|\+380\(\d{2}\)\d{3}-\d{2}-\d{2}|\+380\(\d{2}\)\d{3}-\d{4}', text)
    return result

phones = ("Irma +380(67)777-7-771", "second +380(67)777-77-77", "aloha a@test.com abc111@test.com.net +380(67)111-777-777+380(67)777-77-787")
print(find_all_phones(phones))

#['+380(67)777-7-771', '+380(67)777-77-77', '+380(67)111-777-777', '+380(67)777-77-787']. 
...
#поверне наступний список ['+380(67)777-7-771', '+380(67)777-77-77', '+380(67)777-77-78']