...
Формат запису, в межах навчання приймемо спрощений, такий як: ім'я співробітника,
символ пропуску та його посада, тобто, ким він працює.
...
def get_employees_by_profession(path, profession):
    ...
    matchining_lines = [line.strip()[0] for line in lines if profession in line]
    result = ' '.join(matchining_lines)
