...
Тобто при виклику методу say в екземпляра класу Cat викликається нова реалізація, 
а не успадкована від класу Animal
...
# Викликаємо метод say для кота
print(cat.say())  # Повинно вивести 'Meow'